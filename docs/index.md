...
|------|------|--------|---------------|
| 0 | Non-interference --- identical tokens + logits with/without hooks | **Pass** | 2026-03-15 |
| 1 | Parity --- recomputed fp32 softmax through o_proj matches native | **Pass** | 2026-03-15 |
| 2 | Stability --- 50 generations, zero VRAM creep | **Pass** | 2026-03-18 |
...
**2026-03-18** --- [Gate 2 passes](instrument/gate-2.md). 50 consecutive generations, zero VRAM creep.

**2026-03-15** --- [Gates 0 and 1 pass](instrument/gate-discipline.md). Instrument verified on Mistral-7B.
