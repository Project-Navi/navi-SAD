...
- Shai, A., Teixeira, L., Oldenziel, A. G., Marzen, S., & Riechers, P. (2024). Transformers Represent Belief State Geometry in their Residual Stream. In *Advances in Neural Information Processing Systems* (NeurIPS 2024). [arXiv:2405.15943](https://arxiv.org/abs/2405.15943).
